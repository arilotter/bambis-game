...
pub fn update_confirmed_frame(
    ...
    log::trace!("confirmed frame: {}", confirmed_frame.0);
}

pub fn update_current_frame(mut current_frame: ResMut<CurrentFrame>) {
    current_frame.0 += 1;
    log::trace!("---- start frame {} ----", current_frame.0);
}
...
pub fn update_current_session_frame(
    ...
    log::trace!("current session frame: {}", current_session_frame.0);
}
...
pub fn update_validatable_frame(
    ...
    log::trace!("validatable frame: {}", validatable_frame.0);
}
